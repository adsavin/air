...
class BillSale extends CActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'bill_sale_id' => Yii::t("lang", "รหัสบิล"),
            'bill_sale_created_date' => 'วันที่ทำรายการ',
            'bill_sale_status' => Yii::t("lang", "bill_status"),
            'member_id' => Yii::t("lang", "member"),
            'bill_sale_vat' => Yii::t("lang", "vat"),
            'user_id' => Yii::t("lang", "sales_person"),
            'branch_id' => Yii::t("lang", "branch"),
            'bill_sale_pay_date' => Yii::t("lang", "date_paid_received_the_bill"),
            'bill_sale_drop_bill_date' => Yii::t("lang", "the_billing_date")
        );
    }
