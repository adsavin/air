...
<div class="panel panel-info" style="margin: 10px">
  ...
  <div class="navbar-primary mynav">
    <ul class="nav navbar-nav">
      <li><a href="index.php?r=Config/ProductForm"><i class="glyphicon glyphicon-plus"></i> <?php echo Yii::t('lang', 'add'); ?></a></li>
      <li><a href="index.php?r=Config/ProductIndex&productTag=true"><i class="glyphicon glyphicon-ok"></i> <?php echo Yii::t('lang', 'often_sellers'); ?></a></li>
      <li><a href="index.php?r=Config/ProductIndex"><i class="glyphicon glyphicon-th-list"></i> <?php echo Yii::t('lang', 'all_product'); ?></a></li>
      <li><a href="index.php?r=Config/ProductImportFromExcelFile"><i class="glyphicon glyphicon-download"></i> <?php echo Yii::t('lang', 'import_from_excel_files'); ?></a> </li>
    </ul>
  </div>
