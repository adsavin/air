...
<div class="panel panel-info" style="margin: 10px">
	<div class="panel-heading"><?php echo Yii::t('lang', 'sizing_bill'); ?></div>
	<div class="panel-body">
		<form method="post" name="formBillConfig">
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						<th><?php echo Yii::t('lang', 'named_bill'); ?></th>
						<th width="140px"><?php echo Yii::t('lang', 'text_size_px'); ?></th>
						<th width="120px"><?php echo Yii::t('lang', 'width'); ?></th>
						<th width="120px"><?php echo Yii::t('lang', 'height'); ?></th>
						<th width="80px">A4</th>
						<th width="80px">A5</th>
						<th width="80px"><?php echo Yii::t('lang', 'vertical'); ?></th>
						<th width="80px"><?php echo Yii::t('lang', 'horizontal'); ?></th>
						<th width="80px"><?php echo Yii::t('lang', 'line_display'); ?></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><?php echo Yii::t('lang', 'sales_slip'); ?></td>
						<td>
					...
					<tr>
						<td><?php echo Yii::t('lang', 'invoice'); ?></td>
						<td></td>
						<td>
							<input type="text" 
					...
					<tr>
						<td><?php echo Yii::t('lang', 'billing'); ?></td>
						<td></td>
						<td>
							<input type="text" 
					...
					<tr>
						<td><?php echo Yii::t('lang', 'tax_invoice'); ?></td>
						<td></td>
						<td>
							<input type="text" 
					...
					<tr>
						<td><?php echo Yii::t('lang', 'receipt'); ?></td>
						<td></td>
						<td>
							<input type="text" 
