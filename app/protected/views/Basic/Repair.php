...
<div class="panel panel-info" style="margin: 10px">
    <div class="panel-heading"><?php echo Yii::t('lang', 'product_repair'); ?></div>
    <div class="panel-body">
        ...
        <?php if (!empty($product)): ?> 
            ...
            <div><strong><?php echo Yii::t('lang', 'general_information'); ?></strong></div>
            <form>
                    ...
                    <div>
                        ...
                        if (!empty($product->group_product)) {
                            ...
                            echo $form->textField($product, 'group_product_id', array(
                                ...
                                'class' => 'form-control',
                                'style' => 'width: 560px',
                                'value' => Yii::t('lang', 'this_product_is_not_classified_tnformation_category_is_deleted')
                            ));
                        }
                        ?>
                    </div>
            ...
            <div><strong><?php echo Yii::t('lang', 'full_service_history'); ?></strong></div>
            <div class="well well-small">
                <?php
                if (!empty($repairs)) {
  ...
  <div class="modal-dialog" style="width: 850px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo Yii::t('lang', 'product_selection'); ?></h4>
      </div>
