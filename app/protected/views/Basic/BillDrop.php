...
<div class="panel panel-info" style="margin: 10px">
    <div class="panel-heading"><?php echo Yii::t('lang', 'print_invoices'); ?></div>
    <div class="panel-body">
        ...
        <div>
            <label><?php echo Yii::t('lang', 'sales_person'); ?></label>
            <?php echo CHtml::radioButton('bill_status', $bill_status == 'all' || empty($bill_status), array('value' => 'all')); ?> <?php echo Yii::t('lang', 'all_states'); ?>
            <?php echo CHtml::radioButton('bill_status', $bill_status == 'no', array('value' => 'no')); ?> <?php echo Yii::t('lang', 'no_billing'); ?>
            <?php echo CHtml::radioButton('bill_status', $bill_status == 'drop_no', array('value' => 'drop_no')); ?> <?php echo Yii::t('lang', 'billing_and_wait_payment'); ?>
            <?php echo CHtml::radioButton('bill_status', $bill_status == 'drop_pay', array('value' => 'drop_pay')); ?> <?php echo Yii::t('lang', 'paid_the_bill'); ?>
        </div>
        <div>
            <label></label>
            <a href="#" class="btn btn-info" onclick="showData();">
                <i class="glyphicon glyphicon-ok"></i>
                <?php echo Yii::t('lang', 'lists'); ?>
            </a>
        </div>
        <?php $this->endWidget(); ?>
        <hr />
