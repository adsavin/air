...
<div class="panel panel-info" style="margin: 10px">
    <div class="panel-heading">
	   <?php echo Yii::t('lang', '‘get_the_goods_on_the_bill'); ?> :
    ...
    <div class="panel-body">
        ...
        <div>
            <label><?php echo Yii::t('lang', 'purchase_price'); ?></label>
        ...
        <form class="form-inline">
            <div>
                <label style="width: 100px"><?php echo Yii::t('lang', 'all_admission'); ?>: </label>
                ...
                <label><?php echo Yii::t('lang', 'the_total_amount'); ?>: </label>
  ...
  <div class="modal-dialog" style="width: 850px">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo Yii::t('lang', 'select_product'); ?></h4>
      </div>
