...
class HelpController extends Controller {
  ...
  public function actionUpdateSoftwareNow() {
    ...
    try {
      $sql = "ALTER TABLE tb_repair ADD repair_name VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'ลูกค้า' NOT NULL";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_repair ADD repair_product_name VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'สินค้า' NOT NULL";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_member ADD remark VARCHAR(1000) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT 'รายละเอียดเพิ่มเติม'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE config_software ADD serial_port VARCHAR(10) DEFAULT 'COM1' NOT NULL COMMENT 'Serial PORT'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD quotation_id INT(11) NULL COMMENT 'รหัสใบเสนอราคา'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD vat_percen INT(2) NULL COMMENT 'ภาษี'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD vat_bath FLOAT NULL COMMENT 'จำนวนค่าภาษี'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_bill_sale_detail ADD sub FLOAT NULL COMMENT 'ส่วนลด'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    try {
      $sql = "ALTER TABLE tb_bill_sale_detail ADD quotation_detail_id INT(11) NULL COMMENT 'รหัสรายการ ในใบเสนอราคา'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    // add column
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD customer_name VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'ชื่อลูกค้า'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    // add column
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD customer_tel VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'เบอร์โทร'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    // add column
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD customer_tax VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'เลขผู้เสียภาษี'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
    ...
    // add column
    try {
      $sql = "ALTER TABLE tb_bill_sale ADD customer_address VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'ที่อยู่ลูกค้า'";
      Yii::app()->db->createCommand($sql)->execute();
    } catch (Exception $e) {
